...
#pragma region IBindCallbackRedirect
...
HRESULT __stdcall Core::Net::WebCallback::OnProgress(ULONG ulProgress, ULONG ulProgressMax, ULONG ulStatueCode, LPCWSTR szStatusText)
{
    switch (ulStatueCode)
    {
    ...
    case BINDSTATUS_DOWNLOADINGDATA:
    {
        ...
        if (lastPercent < _percent)
        {
            ...
            std::cout << _percent << "%/" << (float)ulProgressMax << "%/" << std::endl;
...
#pragma endregion IBindCallbackRedirect