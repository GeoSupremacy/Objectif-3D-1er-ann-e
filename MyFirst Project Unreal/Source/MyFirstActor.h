...
class MYFIRSTPROJECT_API AMyFirstActor : public AActor
{
	...
	UPROPERTY(EditAnywhere, Category = "Location")
		bool useOffset = true;
	UPROPERTY(EditAnywhere, Category = "Location")
		bool isInstanceSpawn = true;
	UPROPERTY(EditAnywhere, Category = "Location")
		bool isControledBye = false;

	UPROPERTY(EditAnywhere, Category = "Location", meta = (EditCondition = "useVector"))
		FVector originLocation  =FVector(100);
	UPROPERTY(EditAnywhere, Category = "Location", meta = (EditCondition = "!useVector"))
		TObjectPtr<AActor> targetSpawn = nullptr;
	UPROPERTY(EditAnywhere, Category = "Location", meta = (EditCondition = "usOffset"))
		FVector offset = FVector(0);

	UPROPERTY(EditAnywhere, Category = "Location|Movement", meta = (EditCondition = "!isInstanceSpawn", UIMin =0, UIMax = 200, ClampMin =0, ClampMax = 200))
		float speed = 100;
	UPROPERTY(EditAnywhere, Category = "Location|Movement", meta = (EditCondition = "!isInstanceSpawn"))
		bool canMove = true;
...
public:	
	...
	FORCEINLINE void SetInstantSpawn(const bool& _value) { isInstanceSpawn = _value; }
	FORCEINLINE void SetUseVector(const bool& _value) { useVector = _value; }
	FORCEINLINE void SetOffset(const FVector& _value) { offset = _value; }
