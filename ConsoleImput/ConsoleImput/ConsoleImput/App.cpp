...
App::App()
{
	...
	currentMode = ENABLE_EXTENDED_FLAGS | ENABLE_WINDOW_INPUT | ENABLE_MOUSE_INPUT; //Flags clavier | souris
...
{
	if (_keyEvent.bKeyDown && _keyEvent.uChar.AsciiChar == VK_ESCAPE) //Escape
		isOpen = false;
}
