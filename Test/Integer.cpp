...
//Core::PrimitiveType::Integer Core::PrimitiveType::Integer::operator==(const Integer& _other) const { const Integer* _other = dynamic_cast <const Interger>??  if (_other == nullptr) return *this; value = _other->value; return * this;}
