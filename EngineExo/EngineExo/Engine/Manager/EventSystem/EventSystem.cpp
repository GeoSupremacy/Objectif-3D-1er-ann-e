...
void Engine::Manager::EventSystem::RemoveHoveredElement(const Engine::UI::UIElement* _element)
{
...
void Engine::Manager::EventSystem::Register(Engine::UI::UIElement* _element)
{
    elements.push_back(_element);
}
void Engine::Manager::EventSystem::UnRegister(Engine::UI::UIElement* _element)
{
...
void Engine::Manager::EventSystem::CheckPointerClickHandler(const sf::Event& _event, Engine::UI::UIElement* _element)
{
