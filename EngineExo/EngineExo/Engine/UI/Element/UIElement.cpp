...
Engine::UI::UIElement::UIElement() : super()
{
...
{
    check((shape != nullptr), "shape is null" , PrimaryType::Vector2(0,0))
    return PrimaryType::Vector2();
}
float Engine::UI::UIElement::Rotation() const
{
    check((shape != nullptr), "shape is null",0)
...
{
    check((shape != nullptr), "", PrimaryType::Vector2(0, 0))
...
{
    checkLow((shape != nullptr), "shape null for draw")
