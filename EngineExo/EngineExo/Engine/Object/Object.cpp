...
Engine::PrimaryType::String Engine::Object::ClassName() const
{
	...
	return _str.SubString(_str.FindLastOf(':') + 1).Trim(); //On retour le nom de la class en enlevent 'class' et les espaces
}
...
//La sérialisation est un mécanisme permettant de convertir un objet en une séquence d'octets afin qu'il puisse être stocké en mémoire
void Engine::Object::Serialize(std::ostream& _os, int _index)
{
	...
	// Ajouter le nom de la classe au fichier  => os
