...
{
	shape = new sf::RectangleShape(Engine::PrimaryType::Vector2(Engine::Window::EngineWindow::Instance()->Width(), 150));
	shape->setFillColor(sf::Color(50, 50, 50, 255));
	SetPosition(PrimaryType::Vector2(0, Engine::Window::EngineWindow::Instance()->Height() - 150));
}
...
void Engine::Editor::AssetWindow::RefreshAssetGUI()
{
	...
	PrimaryType::Vector2 _position;
	_position = PrimaryType::Vector2(50, Window::EngineWindow::Instance()->Height() - 140);
...
void Engine::Editor::AssetWindow::OnOpen()
{
	RefreshAssetGUI();
	super::OnOpen();
}
